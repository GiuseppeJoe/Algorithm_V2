...
def launch_on_pump_fun(name, ticker, description, image_prompt="", bundled=False):
    """
    ...
    print(f"⚡ INITIALIZING {mode} WEB3 DEPLOYER FOR {ticker}...")
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            print(f"❌ {mode} DEPLOYMENT FAILED!")
            print(result.stderr)
